...
BRANCHES = [
    ...
    (
        ...
        "RESULT: 74.8% of packages on the language repository are 'Security Scanning Not Supported' "
    ...
    (
        ...
        "packages.dependencies drops 10,420 -> under 200 on the language repository; wall 342.5s -> ~222s; "
    ...
    (
        ...
        "44,850 edges. Edges are modest on the language repository (7,653 for 7,544 nodes) so this matters most "
    ...
    (
        ...
        "MEASURED: payload tracks CVE volume, NOT package count. the container repository (214 packages) "
        "serialised to 25.2 MB (~117 KB/node) while the language repository (7,490 packages) was only 4.2 MB. "
        ...
        "Transfer size recorded before/after on the container repository; SidePanel still shows full "
