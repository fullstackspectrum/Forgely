...
# Graph payloads are large and highly repetitive: 4.2 MB for the language repository and
# 29.2 MB for the container repository, whose 21,598 CVE descriptions repeat across
...
# deduplication downstream already absorbs this: the container repository generates
...
def _build_graph(api_key: str, owner: str, repo: str, refresh: bool = False,
    ...
    *on_progress(phase, done, total)* reports build progress for the streaming
    ...
    for pkg in packages:
        ...
        # list, so the call is pure waste — 74.8% of packages on the language repository
...
def get_package_cve_details(request: Request, owner: str, repo: str, slug: str):
    ...
    the container repository, 21.5 MB of the 29.2 MB — and none are visible until a
...
def _merge_cve(cve_map: dict, cve_id: str, severity: str, description: str, package: str) -> None:
    ...
    agree: on a 300-package container repository, 134 of 4,130 ids carry more
