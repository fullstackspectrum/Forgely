...
var PictogramCenteringCorrector = function() {
  function PictogramCenteringCorrector2() {
    _classCallCheck(this, PictogramCenteringCorrector2);
    this.canvas = document.createElement("canvas");
    this.context = this.canvas.getContext("2d", {
      willReadFrequently: true
    });
  }
  _createClass(PictogramCenteringCorrector2, [{
...
var TextureManager = function(_EventEmitter) {
  _inherits(TextureManager2, _EventEmitter);
  function TextureManager2() {
    var _this;
    var options = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    _classCallCheck(this, TextureManager2);
    _this = _callSuper(this, TextureManager2);
...
function createNodeImageProgram(options) {
  ...
  return _NodeImageProgram = function(_NodeProgram) {
    _inherits(NodeImageProgram2, _NodeProgram);
    function NodeImageProgram2(gl2, pickingBuffer, renderer) {
      var _this;
      _classCallCheck(this, NodeImageProgram2);
      _this = _callSuper(this, NodeImageProgram2, [gl2, pickingBuffer, renderer]);
    ...
    _createClass(NodeImageProgram2, [{
      key: "getDefinition",
